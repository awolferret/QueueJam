...
public class FontController : MonoBehaviour
{
    ...
    private float _nineHundredSixty = 960;
    ...
    private void Start()
    {
        ...
        {
            _text.fontSize = _threeHundredFifty;
        }
